...
import { Eye, ThumbsUp, Share, Download, Clock, User, Calendar, Crown, Bot, Volume2, Sparkles } from 'lucide-react';
...
import { checkSubscriptionStatus } from '../lib/integrations/revenuecat';
  ...
  const fetchVideoData = async () => {
    try {
      ...
      setVideo({
        ...
        description: 'Learn the fundamentals of algebra with clear explanations and examples. This comprehensive tutorial covers variables, equations, and problem-solving techniques that will help you master algebraic concepts.',
        subject: 'Mathematics',
      ...
      setTimestamps([
        { id: '1', title: 'Introduction', time_seconds: 0 },
        { id: '2', title: 'What is Algebra?', time_seconds: 120 },
        { id: '3', title: 'Variables and Constants', time_seconds: 300 },
        { id: '4', title: 'Basic Operations', time_seconds: 600 },
        { id: '5', title: 'Solving Equations', time_seconds: 900 },
      ]);
